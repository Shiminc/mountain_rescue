"""
this script show number of different weather with stacked bar chart
...
def main():
    variables = ['Incident', 'Incident_Cause', 'Incident_Type', 'url','hrs','staff','total_hrs','year','month',
                 'year_month', 'Other Agencies', 'Weather']
    ...
    create_stacked_bar(weather, 'Weather', 'Incident_Cause').show()
    print('finish')
main()