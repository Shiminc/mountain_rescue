...
4. `timeseries` - statistical modelling and plotting (arima, sarima, decomposition) and machine learning (linear regression, SVM, random forest, xgboost) of timeseries
