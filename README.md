...
This is a toy project of mine to practice several programming skills and engage in various visualisation design to understand the best strategy for different scenarios. 
...
4. utils - utilities functions created to be used in other modules 
